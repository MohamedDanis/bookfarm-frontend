...
import UserInfoForm from "@/components/multiform/UserInfoForm";
import PlanForm from "@/components/multiform/PlanForm";
import AddonsForm from "@/components/multiform/Addsonform";
import FinalStep from "@/components/multiform/FinalStep";
import SuccessMessage from "@/components/multiform/SuccessMessage";
  ...
  return (
    <div
      className={`flex justify-center flex-col ${
        currentStepIndex === 1 ? "h-[600px] md:h-[400px]" : ""
      } w-11/12 max-w-4xl relative m-1 rounded-lg  border-neutral-700 bg-[#fff] p-4`}
    >
      {/* {!showSuccessMsg ? (
