        ...
        if (variant === "circle") {
          return (
            <li
              ...
              className={cn(
                "flex gap-4 items-center rounded-md transition-colors shrink-0",
                className
              )}
            >
              <CircleStepIndicator
      ...
      Panel: ({ children, asChild, ...props }) => {
        ...
        return (
          <Comp
            ...
            ref={(node:any) => {
              if (node) scrollIntoStepperPanel(node, tracking);
            }}
    ...
    >
      <svg width={size} height={size}>
        ...
        <circle
          ...
          className="transition-all duration-300 ease-in-out text-slate-900 dark:text-slate-50"
...
const classForSeparator = cva(
  [
    ...
    "data-[state=completed]:bg-slate-900 data-[disabled]:opacity-50 dark:data-[state=completed]:bg-slate-50",
